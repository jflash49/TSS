...
<div class="tbl-asset-test-mouse-view">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            'label'=>'Type'],
            //'type',
            ['attribute'=>'checkLeftButton.status_name',
            'label'=>'Check Left Button'],
            ['attribute'=>'checkRightButton.status_name',
            'label'=>'Check Right Button'],
            ['attribute'=>'checkScrollWheel.status_name',
            'label'=>'Check ScrollWheel'],
           // 'check_left_button',
            //'check_right_button',
           // 'check_scroll_wheel',
            'created_date:date',
